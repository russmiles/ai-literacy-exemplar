...
- **Date**: 2026-04-14
- **Agent**: subagent-driven-development (via brainstorming → writing-plans → subagent pipeline)
- **Task**: Add --format flag to mdcheck with text, JSON, and GitHub Actions annotation output formats
